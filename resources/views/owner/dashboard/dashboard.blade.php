...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Penambahan Produk per Bulan ({{ date('Y') }})
                    </h6>
                </div>
                <div class="card-body">
        ...
        @includeWhen(isset($topCategories), 'owner.dashboard._top_kategori_card', [
    ...
    @if (session('success'))
        <script>
            window.dashboardSuccessMessage = @json(session('success'));
        </script>
    @endif
@endsection
