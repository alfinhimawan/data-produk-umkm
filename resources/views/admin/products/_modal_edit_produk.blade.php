                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="edit_id_kategori" name="id_kategori" required disabled>
                            ...
                            <div class="form-group">
                                <label for="edit_id_umkm">UMKM</label>
                                <select class="form-control" id="edit_id_umkm" name="id_umkm" required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="edit_foto" name="foto" accept="image/*" onchange="window.previewEditFotoProduk(event)">
